...
<script>
var firstPos,interval;$(document).ready(function(){firstPos=$("div#featured_img").css('right').slice(0,-2);interval=setInterval(slideMove,20)});function slideMove(){var pos=$("div#featured_img").css('right').slice(0,-2);if(pos==0){var element=$("#featured_img").children()[0];$("#featured_img").children()[0].remove();$("#featured_img").append(element);pos=firstPos}
$("div#featured_img").css('right',parseInt(pos)+1)}</script>
