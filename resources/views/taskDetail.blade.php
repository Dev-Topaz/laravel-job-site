...
<header class="bg-white">
  ...
  <script>
    function onReleaseClick(e){if("releaseConfirm"==e){$("div#confirmModal #modalBody").html("");var o=$("<img src={{asset('img/loading.gif')}} class='mx-auto w-32 pt-8'/>");$("div#confirmModal #modalBody").append(o);const e={Accept:"application/json"};var t="{{ url('/') }}/api/releaseDeposit/{{$requests->request_id}}?api_token=";t+=$("meta[name=api-token]").attr("content"),console.log(t),$.ajax({url:t,type:"GET",headers:e,success:function(e){console.log(e),$("span#released").text("{{number_format($requests->amount, 2)}}"),$("span#progress").text("0.00"),$("div#confirmModal").hide(),$("div#reviewModal").show()},error:function(e,o,t){console.log(e,o,t)}})}else{$("div#giftConfirmModal #modalBody").html("");o=$("<img src={{asset('img/loading.gif')}} class='mx-auto w-32 pt-8'/>");$("div#giftConfirmModal #modalBody").append(o);const e={Accept:"application/json"};t="{{ url('/') }}/api/completeRequest/{{$requests->request_id}}?api_token=";t+=$("meta[name=api-token]").attr("content"),console.log(t),$.ajax({url:t,type:"GET",headers:e,success:function(e){console.log(e),$("p#status").text("Completed"),$("div#giftconfirmModal").hide(),$("div#reviewModal").show()},error:function(e,o,t){console.log(e,o,t)}})}}
  </script>
@endsection
