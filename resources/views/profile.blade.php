...
<script>
  var swiper=new Swiper(".swiper-container",{slidesPerView:2,spaceBetween:35,freeMode:!0});function openTab(e,t){var n,o,s,a=$("div.swiper-slide").css("width");for(console.log(a),null!=a&&(a=a.slice(0,-2),console.log(a),height=1.1*parseInt(a),console.log(height),$("div.swiper-slide").css("height",height+"px")),o=document.getElementsByClassName("tabcontent"),n=0;n<o.length;n++)o[n].style.display="none";for(s=document.getElementsByClassName("tablink"),n=0;n<s.length;n++)s[n].style.backgroundColor="";document.getElementById(e).style.display="block",t.style.backgroundColor="white"}function toggleSaved(){var e="{{ url('/') }}/api/savedToggle/{{$accountInfo->id}}?api_token=";e+=$("meta[name=api-token]").attr("content"),console.log(e),$.ajax({url:e,type:"GET",headers:{Accept:"application/json"},success:function(e){1==e.data?$("p#saved").css("color","#0f97cd"):$("p#saved").css("color","rgb(156, 163, 175)")},error:function(e,t,n){console.log(e,t,n)}})}function sendRequest(){const e='{{ url("/") }}/api/influencerRequest/{{ $accountInfo->id }}?api_token='+$("meta[name=api-token]").attr("content");$.ajax({url:e,type:"get",success:function(e){console.log("success"),$("div#modal").hide(),$("div#successAlert").fadeIn(200).delay(2e3).fadeOut(200),$("a#sendRequest").addClass("inactive"),$("a#sendRequest").text("Requested")},error:function(e,t,n){console.log(e,t,n)}})}document.getElementById("defaultOpen").click();
