...
@section('content')
    ...
    <div class="md:overflow-auto md:h-screen">
        <div>
            ...
            <div class="px-2 w-full md:float-left md:px-5 lg:px-5">
                    ...
                    <div class="col-span-1 px-2 py-2">
                        <div class="w-full rounded-xl bg-white px-4 py-3 shadow-sm">
                            <div class="flex justify-between text-3xl text-gray-400">
                                ...
                                <div>
                                    <img src="{{ asset('img/total_users.png') }}" alt="total users" width="64">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="grid grid-cols-2 gap-x-1 md:gap-x-2 gap-y-2">
                                    <div class="col-span-1">
                                        ...
                                        <div class="float-left"><p
                                                class="text-xs md:text-sm text-gray-500 ml-1 md:ml-3 ">Completed</p>
                                        </div>
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <div class="float-left"><p
                                                class="text-xs md:text-sm text-gray-500 ml-1 md:ml-3 ">Disputed</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="col-span-1">
                                        ...
                                        <div class="float-left"><p
                                                class="text-xs md:text-sm text-gray-500 ml-1 md:ml-3 ">In Progress</p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="col-span-1">
                                        ...
                                        <div class="float-left"><p
                                                class="text-xs md:text-sm text-gray-500 ml-1 md:ml-3">Accepted</p></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-x-2">
                                    <div class="col-span-1">
                                        ...
                                        <select name="year" id="year"
                                                class="text-xs md:text-sm border-none bg-gray-200 text-gray-500 rounded-lg focus:ring-0"
                                                style="padding: 4px 26px 4px 12px;">
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <select name="month" id="month"
                                                class="text-xs md:text-sm border-none text-gray-500 bg-gray-200 text-gray-500 rounded-lg focus:ring-0"
                                                style="padding: 4px 26px 4px 12px;">
                    ...
                    <div class="col-span-1 px-2 py-2">
                        ...
                        <div class="w-full px-2 py-2 bg-white rounded-xl shadow-sm h-96">
                            <div class="w-full grid grid-cols-2 gap-x-2 mt-3">
                                <div class="col-span-1">
                                    <select name="year" id="year"
                                            class="w-full text-xs md:text-sm border-none text-gray-500 bg-gray-200 text=gray-500 rounded-lg focus:ring-0">
                                        @for($i = 2021; $i <= date('Y'); $i ++)
                                            <option value="$i">{{ $i }}</option>
                                        @endfor
                                    </select>
                                ...
                                <div class="col-span-1">
                                    <select name="month" id="month"
                                            class="w-full text-xs md:text-sm border-none bg-gray-200 text-gray-500 rounded-lg focus:ring-0">
                                        <option value='1'>Jan</option>
                                        <option value='2'>Feb</option>
                                        <option value='3'>Mar</option>
                                        <option value='4'>Apr</option>
                                ...
                                @foreach($referrals as $referral)
                                    <tr class="py-2">
                                        <td style="width: 25%" class="text-xs md:text-lg">
                                            <div class="flex align-items-center"><img class="w-12 float-left rounded-full mr-2 hidden md:block"
                                                src="{{ url('storage/profile-image/'.$referral->influencerInfo->avatar.'.jpg') }}"
                                                alt="{{ $referral->influencerInfo->avatar }}"><p>{{ $referral->influencerInfo->name }}</p>
                                            </div>
                                        </td>
                                        <td style="width: 25%" class="text-xs md:text-lg">
                                            <div class="flex align-items-center">
                                                <img class="w-12 float-left rounded-full mr-2 hidden md:block"
                                                     src="{{ url('storage/profile-image/'.$referral->referral_userInfo->avatar.'.jpg') }}"
                                                     alt="{{ $referral->referral_userInfo->avatar }}">
                                                <p>{{ $referral->referral_userInfo->name }}</p>
                                            </div>
                                        </td>
                                        <td style="width: 25%"
                                            class="text-xs md:text-lg">{{ $referral->influencerInfo->state.', '.$referral->influencerInfo->country }}</td>
                                        <td style="width: 25%" class="text-xs md:text-lg">
                                            <div class="w-full grid grid-cols-3 gap-x-2">
                                                <div class="col-span-1">
                                                    <a href="{{ $referral->influencerProfile->instagram }}"
                                                       class="text-center leading-10"><i class="fab fa-instagram"
                                                                                         style="background:-webkit-linear-gradient(#792ec5, #c62e71, #da8a40);-webkit-background-clip: text;-webkit-text-fill-color: transparent;"></i></a>
                                                </div>
                                                <div class="col-span-1">
                                                    <a href="{{ $referral->influencerProfile->youtube }}"
                                                       class="text-center leading-10 text-red-700"><i
                                                            class="fab fa-youtube"></i></a>
                                                </div>
                                                <div class="col-span-1">
                                                    <a href="{{ $referral->influencerProfile->tiktok }}"
                                                       class="text-center leading-10"><i class="fab fa-tiktok"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
