...
<script>
    function toggleCurPassword(){"password"==$("input#curPassword").attr("type")?($("input#curPassword").attr("type","text"),$("a#toggleCurPassword i").removeClass("fa-eye").addClass("fa-eye-slash")):($("input#curPassword").attr("type","password"),$("a#toggleCurPassword i").removeClass("fa-eye-slash").addClass("fa-eye"))}function toggleNewPassword(){"password"==$("input#newPassword").attr("type")?($("input#newPassword").attr("type","text"),$("a#toggleNewPassword i").removeClass("fa-eye").addClass("fa-eye-slash")):($("input#newPassword").attr("type","password"),$("a#toggleNewPassword i").removeClass("fa-eye-slash").addClass("fa-eye"))}
</script>
@endsection
