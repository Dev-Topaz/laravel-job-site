            ...
            <div class="bg-gray-100 block w-full border-none rounded text-gray-700 font-semibold mb-3 shadow-inner px-2 py-1 relative" style="min-height: 4rem">
              <div class="float-right w-20 text-center absolute" style="top: 50%; transform:translateY(-50%); right: 10px">
                <a onclick="editImg('portfolio')">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="44" height="44" viewBox="0 0 44 44" style="margin:auto;">
                    <image x="4" y="7" width="36" height="31" xlink:href="data:img/png;base64,"/>
                  </svg>
...
<script>
  var cropper,filesValue,width,height,position,$modal=$("#modal"),image=document.getElementById("image"),api_token=$("meta[name=api-token]").attr("content");function categoryToggle(){const e=$("div#categories_box");e.toggle(),"none"==e.css("display")?$("a#categoryToggle i").removeClass("fa-chevron-up").addClass("fa-chevron-down"):$("a#categoryToggle i").removeClass("fa-chevron-down").addClass("fa-chevron-up")}function checkboxClick(e){const a=$("input#categories");let t=$(a).val();const o=$("div#categories_box input[type='checkbox']");t="";let i=0;for(let a=0;a<o.length;a++){const n=o[a];$(n).is(":checked")&&i<2?(t+=$(n).parent().text(),console.log(t),i++):$(n).is(":checked")&&i>=2&&$(e).trigger("click")}a.val(t)}function displayLength(){const e=$("textarea#introduction").val();console.log(e),$("span#intro_length").text(e.length)}function editImg(e){position=e;const a=document.getElementById("hidden-input");$("input#position").val(position),a.click(),a.onchange=(e=>{var a,t,o=e.target.files,i=function(e){console.log(e),image.src=e,$modal.modal("show")};o&&o.length>0&&(t=o[0],URL?i(URL.createObjectURL(t)):FileReader&&((a=new FileReader).onload=function(e){i(a.result)},a.readAsDataURL(t)))})}function removeImage(e,a){var t=e.prev().attr("alt"),o="{{ url('/') }}/api/deleteImage?api_token=";o+=api_token,$.ajax({url:o,type:"POST",data:{filename:t,position:a},success:function(a){"success"==a.data&&e.parent().remove()},error:function(e,a,t){console.log(e,a,t)}})}$modal.on("shown.bs.modal",function(){var e;switch(position){case"top":e=.8,width=528,height=660;break;case"round":e=1,width=160,height=160;break;case"portfolio":e=.8,width=528,height=660;break;case"partnership":e=2,width=528,height=264}cropper=new Cropper(image,{aspectRatio:e,viewMode:3,preview:".preview"})}).on("hidden.bs.modal",function(){cropper.destroy(),cropper=null}),$("#crop").click(function(){canvas=cropper.getCroppedCanvas({width:width,height:height}),$("#uploadModal").show(),canvas.toBlob(function(e){url=URL.createObjectURL(e);var a=new FileReader;a.readAsDataURL(e),a.onloadend=function(){var e=a.result;switch(position){case"top":$("img#top-image").attr("src",e);var t="{{ url('/') }}/api/saveImage?api_token=";t+=api_token,(r=new FormData).append("image",e),r.append("position","top"),$.ajax({url:t,data:r,processData:!1,contentType:!1,type:"POST",success:function(e){$("#uploadModal").hide()},error:function(e,a,t){console.log(e,a,t)}});break;case"round":$("img#round-image").attr("src",e);t="{{ url('/') }}/api/saveImage?api_token=";t+=api_token,(r=new FormData).append("image",e),r.append("position","round"),$.ajax({url:t,data:r,processData:!1,contentType:!1,type:"POST",success:function(e){$("#uploadModal").hide()},error:function(e,a,t){var o=e+"<br/>"+a+"<br/>"+t;$("div#error").text(o),console.log(e,a,t)}});break;case"portfolio":var o=$('<div id="gallery-item" class="float-left mr-3 my-2 relative"></div>'),i=$('<img src="'+e+'" alt="" class="rounded-sm" style="width: 65px; box-shadow:0 0 5px #333">'),n=$('<a class="block absolute w-5 h-5 text-center rounded-full bg-red-600 text-white text-xs -top-2 -right-2" onclick="removeImage($(this), \'portfolio\')"><span class="leading-5">X</span></a>');o.append(i),o.append(n),$("#portfolio-gallery").append(o);t="{{ url('/') }}/api/saveImage?api_token=";t+=api_token,(r=new FormData).append("image",e),r.append("position","portfolio"),$.ajax({url:t,data:r,processData:!1,contentType:!1,type:"POST",success:function(e){$("#uploadModal").hide();var a,t="{{ url('/storage/profile-image') }}/"+(a=(a=e.file.split("/"))[a.length-1])+".jpg";$("#portfolio-gallery div:last-child img").attr("src",t),$("#portfolio-gallery div:last-child img").attr("alt",a)},error:function(e,a,t){console.log(e,a,t)}});break;case"partnership":o=$('<div id="gallery-item" class="float-left mr-3 my-2 relative"></div>'),i=$('<img src="'+e+'" alt="" class="rounded-sm" style="width: 65px; box-shadow:0 0 5px #333">'),n=$('<a class="block absolute w-5 h-5 text-center rounded-full bg-red-600 text-white text-xs -top-2 -right-2" onclick="removeImage($(this), \'partnership\')"><span class="leading-5">X</span></a>');o.append(i),o.append(n),$("#partnership-gallery").append(o);var r;t="{{ url('/') }}/api/saveImage?api_token=";t+=api_token,(r=new FormData).append("image",e),r.append("position","partnership"),$.ajax({url:t,data:r,processData:!1,contentType:!1,type:"POST",success:function(e){$("#uploadModal").hide();var a,t="{{ url('/storage/partnership-image') }}/"+(a=(a=e.file.split("/"))[a.length-1])+".jpg";$("#partnership-gallery div:last-child img").attr("src",t),$("#partnership-gallery div:last-child img").attr("alt",a)},error:function(e,a,t){console.log(e,a,t)}})}$modal.modal("hide")}})});
</script>
@endsection
