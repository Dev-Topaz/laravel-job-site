                ...
                <div class="bg-white">
                  ...
                  <strong>{{ $message }}</strong>
                                ...
                                <div id="portfolio-gallery" class="mr-20">
                                    @foreach ($portfolios as $portfolio)
                                        <div id="gallery-item" class="float-left mr-3 my-2 relative">
                                            ...
                                            <a class="block absolute w-5 h-5 text-center rounded-full bg-red-600 text-white text-xs -top-2 -right-2"
                            ...
                            <div
                                ...
                                <button type="button"
                                        class="block py-1 mb-3 w-11/12 mx-auto rounded-xl text-sm bg-white"
